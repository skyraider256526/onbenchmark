...
module.exports = (sequelize, DataTypes) => {
    const ResourceManager = sequelize.define('resourceManager', {
        userName:{
    ...
    ResourceManager.beforeCreate(function (user, options, cb) {
        if (user.password) {
    ...
    ResourceManager.beforeUpdate(function (user, options, cb) {
        if (user.password) {
            return new Promise((resolve, reject) => {
                bcrypt.genSalt(10, function (err, salt) {
                    if (err) {
    ...
    ResourceManager.prototype.comparePassword = function (passw, cb) {
        return new Promise((resolve, reject) => {
