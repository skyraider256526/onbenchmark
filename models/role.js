module.exports = (sequelize, DataTypes) => {
  ...
  Role.removeRole = id =>
    Role.update({ isActive: false }, { where: { id: id, isActive: true } });

  Role.addRole = (role_id, roleName, description, createdBy, updatedBy) =>
    Role.create({ role_id, roleName, description, createdBy, updatedBy });

  Role.updateRole = (roleName, description, updatedBy, id) =>
    Role.update({ roleName, description, updatedBy }, { where: { id } });
